...
#     if(!is.null(RF$do.classif )) { opt@RF$do.classif <- RF$do.classif }
  ...
  if(!is.null(MAXENT)){
    ...
    if(!is.null(MAXENT$background_data_dir )) { opt@MAXENT$background_data_dir <- MAXENT$background_data_dir }
    if(!is.null(MAXENT$maximumbackground )) { opt@MAXENT$maximumbackground <- MAXENT$maximumbackground }
