...
setClass("BIOMOD.Model.Options", 
         ...
         validity = function(object){
           ...
           if(!is.character(object@MAXENT$background_data_dir)){ cat("\nMAXENT$background_data_dir must be 'default' (=> use the same pseudo absences than other models as background) or a path to the directory where your environmental layer are stored"); test <- FALSE }
           ...
           if(!tt){ cat("\nMAXENT$maximumbackground must be 'default' or numeric"); test <- FALSE }
...
setMethod('show', signature('BIOMOD.Model.Options'),
          function(object){
            ...
            cat("\n               background_data_dir = ", ifelse(is.character(object@MAXENT$background_data_dir), "'", ""), object@MAXENT$background_data_dir, ifelse(is.character(object@MAXENT$background_data_dir), "'", ""), ",", sep="")
            cat("\n               maximumbackground = ", ifelse(is.character(object@MAXENT$maximumbackground), "'", ""), object@MAXENT$maximumbackground, ifelse(is.character(object@MAXENT$maximumbackground), "'", ""), ",", sep="")
