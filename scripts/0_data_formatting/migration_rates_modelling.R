##' ----------------------------------------------------------------------------
##' @title Test of migration rate modelling
##' @date 16/10/2015
##' @author Damien G.
##' @description The aim of this script is to explore if we manage to model the
##'   plant migration rate of our shrubs. The final goal is to fill the gaps for
##'   this variable for species we don't have this info. Then we will use this
##'   mig rate modelled to define the migration bundaries of the species in 2080. 
##' @licence GPU.
##' ----------------------------------------------------------------------------
...
dat.try <- read.csv("TRY_for_mig_rate_test.csv", stringsAsFactors = FALSE)
